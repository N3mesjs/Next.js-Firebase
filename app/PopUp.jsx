        ...
        <>
            <div className="popup flex flex-col text-white bg-[#1f1f1f] p-[20px] rounded-2xl justify-center items-center">
                ...
                <form className="flex flex-col">
                    <label for="chatname" className="mb-[10px]">Nome della chat</label>
                    <input className="focus:outline-sky-600 p-[10px] mb-[20px]" type="text" id="chatname" placeholder="Nome Chat"/>
                    ...
                    <input className="focus:outline-sky-600 p-[10px] mb-[20px]" type="text" placeholder="E-mail"/>
